                ...
                <div class="collapse" id="collapseNew">
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Titulo</label>
                            <input type="text" name="titulo_carrusel" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label>Descripción</label>
                            <textarea class="form-control" minlength="10" maxlength="50" required name="descripcion_carrusel" style="height:100px"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="mb-3">
