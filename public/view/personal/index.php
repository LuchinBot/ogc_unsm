...
if (isset($_POST['add'])) {
    ...
    if ($_FILES['foto']['name'] != "") {
        ...
        echo '<script type="text/javascript">window.location="' . $url . 'public/view/personal";</script>';
    }
}
if (isset($_POST['edit'])) {
    $id = $_POST['idpersonal'];
...
$stmt = $base->prepare('SELECT p.idpersonal,p.foto,pn.nombres,pn.apellidos,p.estado,c.descripcion from personal as p
